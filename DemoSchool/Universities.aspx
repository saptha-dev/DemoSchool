<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Universities.aspx.cs" Inherits="DemoSchool.Universities" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container shadow" style="margin-top:2px;background-color:#fff;border-top:5px solid #CCC;">
                ...
                <div class="tabbable">
                    ...
                    <div class="tabbable tabs-left" style="border-style: groove;height:620px;">
                        <ul class="nav nav-tabs">
                            ...
                            <li ><a href="#RD" data-toggle="tab">R&D CENTERS</a></li>
                            <li class="active"><a href="#UNIV" data-toggle="tab">UNIVERSITIES</a></li>
                        </ul>
                        <div class="tab-content" style="border: none;">
                            ...
                            <div class="tab-pane" id="RD" style="height: 591px;">
                                <p>
                                    <b>R&D CENTERS</b>
                            ...
                            <div class="tab-pane active" id="UNIV" style="height: 591px;">
                                <p>
                                    <b>UNIVERSITIES</b>
