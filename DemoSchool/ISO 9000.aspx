<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ISO 9000.aspx.cs" Inherits="DemoSchool.ISO_9000" %>
                    ...
                    <div class="tabbable tabs-left" style="border-style: groove;height:500px;">
                        <ul class="nav nav-tabs">
                            <p style="margin-top: 10px; font-size: 16px; font-weight: bold;">
                                ACCREDITIONS</p>
                            <li class="active" style="margin-top: 69px;"><a href="#ISO" data-toggle="tab">ISO-9000-2008</a></li>
                            <li><a href="#AIU" data-toggle="tab">AIU- ASSOCIATE OF INDIAN UNIVERSITIES</a></li>
                            <li><a href="#IAO" data-toggle="tab">IAO-INTERNATIONAL ACCREDITION ORGANIZATION</a></li>
                        </ul>
                        <div class="tab-content" style="border: none;">
                            <div class="tab-pane active" id="ISO" style="height: 494px;border-radius: 20px;">
                                <p>
                            ...
                            <div class="tab-pane" id="AIU" style="height: 494px;border-radius: 20px;">
                                <p>
