<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="govt-organization.aspx.cs" Inherits="DemoSchool.govt_organization" %>
                    ...
                    <div class="tabbable tabs-left" style="border-style: groove;height:620px;">
                        <ul class="nav nav-tabs">
                            <p style="margin-top: 10px; font-size: 16px; font-weight: bold;">
                                AFFILIATIONS</p>
                            <li class="active" style="margin-top: 69px;"><a href="#Govt" data-toggle="tab">GOVERNMENT ORGANIZATIONS</a></li>
                            <li><a href="#RD" data-toggle="tab">R&D CENTERS</a></li>
                            <li><a href="#UNIV" data-toggle="tab">UNIVERSITIES</a></li>
                        </ul>
                        <div class="tab-content" style="border: none;">
                            <div class="tab-pane active" id="Govt" style="height: 591px;">
                                <p>
